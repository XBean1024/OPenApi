...
public class LoginActivity extends AppCompatActivity implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener {
    ...
    private com.binny.openapi.custom.KeyValueLayout registerphone;
    private com.binny.openapi.custom.KeyValueLayout registerpassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.registerpassword = (KeyValueLayout) findViewById(R.id.register_password);
        this.registerphone = (KeyValueLayout) findViewById(R.id.register_phone);
